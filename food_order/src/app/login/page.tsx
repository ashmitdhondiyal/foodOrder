        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-md w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to your account to continue ordering delicious food</p>
            </div>
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-center p-12">
            <div className="text-center text-white">
              ...
              <h3 className="text-3xl font-bold mb-4">Delicious Food Awaits</h3>
              <p className="text-xl text-indigo-100 max-w-md">
                Sign in to access your favorite restaurants, track orders, and enjoy amazing food delivered to your door.
              </p>
            </div>
          </div>
