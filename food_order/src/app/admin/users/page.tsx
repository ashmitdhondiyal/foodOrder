          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{mockUsers.filter(u => u.role === 'RESTAURANT_OWNER').length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{mockUsers.filter(u => u.role === 'DELIVERY').length}</p>
              </div>
            </div>
          </div>
        </div>
                        ...
                        <div className="ml-4">
                          ...
                          {user.role === 'CUSTOMER' && (
                            <div className="text-xs text-gray-400">
                              {user.totalOrders} orders • ${user.totalSpent?.toFixed(2)} spent
                            </div>
                          )}
                        </div>
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSelectedUser({...selectedUser, role: e.target.value as 'CUSTOMER' | 'RESTAURANT_OWNER' | 'DELIVERY' | 'ADMIN'})}
                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
